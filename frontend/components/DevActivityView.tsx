"use client";
/* ============================================================
   DevActivityView (#120 · #63-P3 · #97 DEVACT) — the git-contribution body, extracted
   so it renders in the /projects "Dev Activity" sub-tab (gộp: Dev Activity folded INTO
   the unified Projects screen, user-CHỐT #120). Ported 1:1 from the old /dev-activity
   page — NO redesign. ALL features kept (mock-diff: KPI strip, #97 analyst row [cpd /
   net-LOC / span / peak-hour / velocity / you-vs-other], range filter 7/14/30/90,
   contribution heatmap, sortable by-repo table, recent-day bars, team-context, scan).

   git-contribution view: "what did I code, which project, when", derived FROM git.
   NOT /activity (that's the automation run-log feed). RENDER-ONLY — the backend computes
   ...
   otherRepos (tagged "other"). The view shows an empty-state-for-you + the
